...
HD_PWD='/home/ming/workspace_ondevice_2/Project_NPU/wafer_npu/wafer_npu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cnn_npu_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cnn_npu_wrapper.tcl
